...
public class GpCom {
	...
	public static enum ERROR_CODE {
		SUCCESS, FAILED, TIMEOUT, INVALID_DEVICE_PARAMETERS, DEVICE_ALREADY_OPEN, INVALID_PORT_NUMBER, INVALID_IP_ADDRESS, INVALID_CALLBACK_OBJECT, BLUETOOTH_IS_NOT_SUPPORT, OPEN_BLUETOOTH, PORT_IS_NOT_OPEN, INVALID_BLUETOOTH_ADDRESS, PORT_IS_DISCONNECT
	}

	public static final int STATE_NO_ERR = 0;
	public static final int STATE_OFFLINE = 0x1;
	public static final int STATE_PAPER_ERR = 0x2;
	public static final int STATE_COVER_OPEN = 0x4;
	public static final int STATE_ERR_OCCURS = 0x8;
	public static final int STATE_TIMES_OUT = 0x10;
	...
	public static final String EXTRA_PRINTER_RECEIPT_RESPONSE="printer.receipt.response";
